...
x_plot <-
    ...
    ggplot(aes(x = region_position, y = region_length, fill = completeness)) +
    geom_col(width = 0.75) +
    ggtitle(file_names[5]) +
...
plots <-
    x_plot + y_plot + a_plot + z_plot + b_plot + plot_layout(guides = "collect", nrow = 1)

# create common lable
wrap_elements(panel = plots) +
    labs(tag = "Bacteriophage Start Position") +
    theme(
