...
system(command = "blastn -query /Users/zuza/repos/H58/docs/sequence.fasta -subject /Users/zuza/repos/H58/outputs/assemblies/polca/A58390.fasta -outfmt 6 -out docs/ct18_a58390_comparison.txt")
...
plot_gene_map(dna_segs = list(dna_seg1, dna_seg3, dna_seg4, dna_seg5),
              gene_type = "arrows",
              annotations = list(annot1, annot3, annot4, annot5),
              comparisons = list(comparison_1, comparison_4, comparison_5),
              dna_seg_scale = TRUE,
              dna_seg_labels = c("CT18", "A58390", "BKQT8S", "BKQU3X"),
              annotation_height = 2,
...
outdir <- "outputs/plots"
plotting_dir <- file.path(outdir, Sys.Date())
plot_name <- file.path(plotting_dir, "cyaA_region.pdf")
