...
```{r}
plot_gene_map(list(dna_seg_ref, dna_seq_1017142), comparisons = list(comparison_1))
```
...
is_elements <- c("IS1X2", "TnAs2" , "tetC" , "IS4321R" , "tetR" , "IS4321L", "ISVsa5" , "ISBcen27", "IS4321R", "IS26", "ISStma11" , "IS5075", "IS1R" , "ISVsa5", "TnAs3", "ISVsa5",  "IS1R" , "IS26")

amr_genes <- c("merR",  "merT_1", "merP_1", "merC_1", "merA_1", "dfrA14" , "blaTEM-1", "sul2", "aph(3'')-Ib",  "aph(6)-Id" , "merA_2" , "merC_2" , "merP_2" , "merP_2" , "merT_2" , "tet(B)", "Sul2" )

other_genes <- c("repE" , "xerC" , "hin" , "hns" , "smc" , "dcm" , "tnpR" , "repA" , "yqjZ" , "umuD" , "umuC", "-", "gltS", "gltS_1", "gltS_2")
