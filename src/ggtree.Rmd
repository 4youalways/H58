...
extra <- read.table("./outputs/microbe/mykrobe_predictResults.tsv",
                    sep="\t", header=TRUE)
...
df1 <- tree_metadata %>% select(!c(sample_name)) %>% rename("sample_name" = "Sample")
